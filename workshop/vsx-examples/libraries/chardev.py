# 2025-0805 PP added print() in CharDev>>input_evt() to print key code
...
DEBUG = False  #True   #2025-0805 PP added to get insights from the code (=True)
...
class CharDev:
    ...
    def read_evt(self) -> InputKey:
        with open(self.path, "rb") as f:
            ...
            if DEBUG:
                # 2025-0805 PP added print() to print key code
                print(f"key data: {InputKey.from_binary(data)}") # PP DEBUG
